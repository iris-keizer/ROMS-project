...
def resample_to_latlon_4d(dataset, variable, resolution = 1.0, mapping_method = 'nearest_neighbor', radius_of_influence = 120000):
    '''
...
data_resampled = resample_to_latlon_4d(data, 'THETA')
...
data_resampled.to_netcdf(f'{path_save}/theta.nc')
