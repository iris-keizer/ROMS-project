...
def createinitfile(confM2R, ntime, var, data1=None, data2=None, data3=None, data4=None):
    ...
    if not grdROMS.ioInitInitialized:
        ...
        if grdROMS.timeunits[0:7] == "seconds":
            ...
            d = num2date(grdROMS.time * 3600.0, units=v_time.long_name, calendar=v_time.calendar) #changed from 86400.0 to 3600 (hours instead of days), by Tim Hermans on 15-10-19
    ...
    if (grdROMS.timeunits[0:7] == "seconds"):
        ...
        f1.variables['ocean_time'][ntime] = grdROMS.time * 3600.0 #changed from 86400.0 to 3600 (hours instead of days), by Tim Hermans on 15-10-19
