    ...
    if confM2R.isclimatology is False:
        if myvar == confM2R.globalvarnames[0]:
            ...
            if grdROMS.timeunits[0:7] == "seconds":
                ...
                f1.variables['ocean_time'][ntime] = grdROMS.time * 3600.0 # changed from 86400.0 to 3600.0 by Tim Hermans, 15-10-19

                d = num2date(grdROMS.time * 3600.0, units=f1.variables['ocean_time'].long_name,# changed from 86400.0 to 3600.0 by Tim Hermans, 15-10-19
                             calendar=f1.variables['ocean_time'].calendar)
            grdROMS.message = d
