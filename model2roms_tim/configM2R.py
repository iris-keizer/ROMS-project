...
class Model2romsConfig(object):
    ...
    def definesubsetforindata(self):
        ...
        if self.outgrid == "NS8_GLORYS12v1": #edited by Tim Hermans for GLORYS 12v1, 15-10-19
            subset[0] = 30
            subset[1] = 70
            subset[2] = -30
            subset[3] = 30
    ...
    def defineabbreviation(self):
        return {"A20": "a20",
                "NS8_GLORYS12v1": "NS8_glorys12v1"}[self.outgrid]
    ...
    def defineinputdatavarnames(self):
        ...
        return {'SODA': ['temperature', 'salinity', 'ssh', 'uvel', 'vvel'],
                ...
                #'GLORYS': ['temperature', 'salinity', 'ssh', 'u', 'v'],
                'WOAMONTHLY': ['temperature', 'salinity'],
    ...
    def defineromsgridpath(self):
        return {'A20': '/Users/trondkr/Dropbox/NIVA/A20/Grid/A20niva_grd_v1.nc', # '/cluster/projects/nn9412k/A20/Grid/A20niva_grd_v1.nc',
                'NS8_GLORYS12v1': '/users/thermans/Documents/Modeling/ROMS/preprocessing/grid/NorthSea8_smooth03_sponge_nudg.nc'}[self.outgrid]
    ...
    def defineforcingdatapath(self):
        return {'SODA3': "/Volumes/DATASETS/SODA3.3.1/OCEAN/", 
                ...
                'GLORYS': "/Volumes/Naamloos/PhD_Data/GLORYS12v1/",
                #'GLORYS': "/Volumes/Naamloos/PhD_Data/GLORYS2v4/",
    ...
    def __init__(self):
        ...
        self.authorname = "Tim Hermans"
        self.authoremail = "tim.hermans (at) nioz.nl"
