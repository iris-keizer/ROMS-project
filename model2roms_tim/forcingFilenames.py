...
def getGLORYSfilename(confM2R, year, month, myvar):
    ...
    # edited to read out my own file names 15-10-19, Tim Hermans
    
    if month<10:
        filename = confM2R.modelpath + 'mercatorglorys12v1_gl12_mean_' \
    ...
    '''
    if month<10:
        filename = confM2R.modelpath + 'mercatorglorys2v4_gl4_mean_' \
        + str(year) + '0' + str(month) \
        + '.nc'
    else:
        filename = confM2R.modelpath + 'mercatorglorys2v4_gl4_mean_' \
