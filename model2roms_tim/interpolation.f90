           ...
           do kc=1,KK
             do jc=1,JJ
                do ic=1,II
                    ...
                    ! also see header roms_vectors.m in MATLAB ROMS package:
                    urot(kc,jc,ic)=u_rho(kc,jc,ic)*COS(angle(jc,ic)) + v_rho(kc,jc,ic)*SIN(angle(jc,ic)) !edited tim hermans
                    vrot(kc,jc,ic)= -u_rho(kc,jc,ic)*SIN(angle(jc,ic)) + v_rho(kc,jc,ic)*COS(angle(jc,ic)) !edited tim hermans
